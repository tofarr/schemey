...
class GraphqlContext:
    ...
    objects: Dict[str, 'old.graphql.ObjectSchema'] = field(default_factory=dict)
    # noinspection PyUnresolvedReferences
    enums: Dict[str, 'old.graphql.EnumSchema'] = field(default_factory=dict)
    # noinspection PyUnresolvedReferences
    unions: Dict[str, 'old.graphql.AnyOfSchema'] = field(default_factory=dict)
