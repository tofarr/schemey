...
class TestIntegerSchema(TestCase):
    ...
    def test_schema_min_length(self):
        ...
        assert list(schema.get_schema_errors("123")) == []
        assert list(schema.get_schema_errors("12")) == [
            SchemaError("", "min_length", "12")
        ]
        assert list(schema.get_schema_errors("12", ["foo", "bar"])) == [
            SchemaError("foo/bar", "min_length", "12")
        ]
    ...
    def test_schema_pattern(self):
        ...
        assert list(schema.get_schema_errors("a1")) == [
            SchemaError("", "pattern", "a1")
        ]
    ...
    def test_format_date(self):
        ...
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:date", "foobar")
        ]
        assert list(schema.get_schema_errors("2021-13-01")) == [
            SchemaError("", "format:date", "2021-13-01")
        ]
    ...
    def test_format_date_time(self):
        ...
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:date-time", "foobar")
        ]
    ...
    def test_format_time(self):
        ...
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:time", "foobar")
        ]
    ...
    def test_format_email(self):
        ...
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:email", "foobar")
        ]
    ...
    def test_format_ipv4(self):
        ...
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:ipv4", "foobar")
        ]
    ...
    def test_format_ipv6(self):
        ...
        assert (
            list(schema.get_schema_errors("ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff"))
            == []
        )
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:ipv6", "foobar")
        ]
    ...
    def test_format_uuid(self):
        ...
        assert list(schema.get_schema_errors("foobar")) == [
            SchemaError("", "format:uuid", "foobar")
        ]
    ...
    def test_schema_wrong_type(self):
        ...
        self.assertEqual(
            [SchemaError("", "type", 10)], list(schema.get_schema_errors(10))
        )
